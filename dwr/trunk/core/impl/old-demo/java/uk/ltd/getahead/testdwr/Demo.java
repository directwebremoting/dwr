...
public class Demo
{
    ...
    public String getServerInfo()
    {
        return WebContextFactory.get().getServletContext().getServerInfo()
               ...
               + " using DWR " + WebContextFactory.get().getVersion(); //$NON-NLS-1$
    }
    ...
    {
        return WebContextFactory.get().getVersion();
    }
    ...
    {
        return WebContextFactory.get().forwardToString("/forward.jsp"); //$NON-NLS-1$
    }
    ...
    public Map<String, String> fillAddress(String origpostcode)
    {
        ...
        String postcode = origpostcode.replace(" ", ""); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        Person fred = new Person("Fred", "1 Red Street", 2, 100000.0f); //$NON-NLS-1$
        Person jim = new Person("Jim", "42 Brown Lane", 3, 20000.0f); //$NON-NLS-1$
        Person shiela = new Person("Shiela", "12 Yellow Road", 4, 3000000.0f); //$NON-NLS-1$
