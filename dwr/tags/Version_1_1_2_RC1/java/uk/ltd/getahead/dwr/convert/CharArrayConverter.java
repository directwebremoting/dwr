 ...
 */
public class CharArrayConverter extends BaseV10Converter implements Converter
{
    /* (non-Javadoc)
    ...
    {
        return "var " + varname + "=\"" + jsutil.escapeJavaScript(new String((char[]) data)) + "\";";  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
